...
dd2:[{c:"000",l:"REGIME ANCIEN PRIMAIRE"},{c:"010",l:"MISE A LA CONSOMMATION DIRECTE"},{c:"023",l:"ATPA SANS PAIEMENT"},{c:"035",l:"ENTREPOT PUBLIC"},{c:"036",l:"ENTREPOT PRIVE BANAL"},{c:"037",l:"ENTREPOT PRIVE PARTICULIER"},{c:"038",l:"ENTREPOT INDUSTRIEL IMPORT"},{c:"060",l:"EXPORTATION EN SIMPLE SORTIE"},{c:"085",l:"TRANSIT A L IMPORT"},{c:"086",l:"TRANSIT A L EXPORT"},{c:"099",l:"MAC MARCHANDISES SOUMISES A TIC"},{c:"381",l:"ENTREPOT INDUSTRIEL FRANC EIF"},{c:"841",l:"TRANSIT"},{c:"901",l:"ZONE FRANCHE"},{c:"941",l:"DEC. PROV. IMPORT SIMPLE"},{c:"945",l:"DEC. OCCAS. IMPORT"}],
dd3:[{c:"1",l:"Articles d edition"},{c:"3",l:"Franchise UNESCO"},{c:"10",l:"Materiel militaires importes par les FAR"},{c:"12",l:"Marchandises en retour sur le territoire assujetti"},{c:"13",l:"Franchises diplomatiques"},{c:"15",l:"Dons oeuvres de bienfaisance"},{c:"1001",l:"Petrole brut"},{c:"1029",l:"Materiels energies renouvelables non agricoles"},{c:"1046",l:"Biens equipement investissement superieur 200 Mdhs"},{c:"2002",l:"Biens investissement"}],
dd4:[{c:"01",l:"AGADIR"},{c:"03",l:"ALHOCEIMA"},{c:"81",l:"CASABLANCA"},{c:"27",l:"FES"},{c:"35",l:"KENITRA"},{c:"43",l:"LAAYOUNE"},{c:"45",l:"MARRAKECH"},{c:"47",l:"MEKNES"},{c:"49",l:"NADOR"},{c:"55",l:"OUJDA"},{c:"85",l:"RABAT"},{c:"57",l:"SAFI"},{c:"59",l:"SETTAT"},{c:"61",l:"TANGER"},{c:"69",l:"TAZA"},{c:"71",l:"TETOUAN"}]
};
...
<div id="classic-view">
  ...
  <div class="c-nav">
    ...
    <a href="/modules/tracking" class="c-nav-item" style="border-color:var(--gold)">
      <span class="cn-num" style="color:var(--gold)">TRK</span>
      <div><div class="cn-label">Tracking & Intelligence</div><div class="cn-sub">AWB · BL · Fret · Assurance · Matières</div></div>
    </a>
    <a href="/modules/procedures" class="c-nav-item" style="border-color:var(--gold)">
      <span class="cn-num" style="color:var(--gold)">PRO</span>
      <div><div class="cn-label">Procédures Douanières</div><div class="cn-sub">Tableau procédures · Étapes DUM</div></div>
    </a>
  ...
  <div class="c-nav">
    ...
    <a href="/dashboard" class="c-nav-item">
      <span class="cn-num">DB</span>
      <div><div class="cn-label">Mon Dashboard</div><div class="cn-sub">Activité · Dossiers · Score conformité</div></div>
    </a>
